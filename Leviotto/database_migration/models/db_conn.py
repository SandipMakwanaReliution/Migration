...
class DBconnection(models.Model):
    ...
    def update_name(self):
        ...
        table_names_with_active = ['account.tax', 'account.account.tag', 'uom.uom', 'hr.job', 'account.payment.term',
                                   'res.partner.category', 'account.journal', 'account.fiscal.position',
        ...
        table_names = ['account.account', 'product.attribute.value', 'product.attribute', 'uom.category',
                       'account.payment.method', 'account.tax.group', 'account.financial.report', 'account.analytic.plan', 'product.brand']
    ...
    def migrate_from_excel(self):
        ...
        # db_name = "leviotto_v17_production_05"
        # username = "admin"
        # password = "admin"
        #
        ...
        #
        # # --- Read Excel File ---
        # excel_path = "/home/sandip/Desktop/Projects/v17_Projects/v17_Leviotto/Script_Excel_Files/Product_Responsible_User.xlsx"
